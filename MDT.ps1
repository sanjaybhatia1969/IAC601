...
New-PSDrive -Name "DS001" -PSProvider "MDTProvider" -Root "C:\DeploymentShare" -Description "MDT Deployment Share" -NetworkPath \\media-server\DeploymentShare | add-MDTPersistentDrive
...
Import-MDTApplication -path "DS001:\Applications" -enable "True" -Name "VLC" -ShortName "VLC" -CommandLine "vlc-3.0.20-win64.exe /L=1033 /S"`
 -WorkingDirectory ".\Applications\VLC" -ApplicationSourcePath "C:\Users\Administrator\Desktop\softwares" -DestinationFolder "VLC" -Verbos
...
Import-MDTApplication -path "DS001:\Applications" -enable "True" -Name "Adobe Acrobat" -ShortName "Adobe Acrobat" -CommandLine "AcroRdrDC2300820533_en_US.exe /sAll /rs /msi EULA_ACCEPT=YES"`
 -WorkingDirectory ".\Applications\Adobe Acrobat" -ApplicationSourcePath "C:\Users\Administrator\Desktop\softwares" -DestinationFolder "Adobe Acrobat" -Verbos
...
Import-MDTApplication -path "DS001:\Applications" -enable "True" -Name "Google Chrome" -ShortName "Google Chrome" -CommandLine "ChromeStandaloneSetup64.exe /silent /install"`
 -WorkingDirectory ".\Applications\Google Chrome" -ApplicationSourcePath "C:\Users\Administrator\Desktop\softwares" -DestinationFolder "Google Chrome" -Verbos
...
[Default]
DeployRoot=\\Media-server\DeploymentShare
